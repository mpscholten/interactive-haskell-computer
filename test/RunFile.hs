...
spec = describe "Phase 1.0 — demand-driven single-pass JIT" do
    ...
    it "TH Lib facade re-exports smart constructors from package source" do
    ...
    it "top-level TH facade loads from package source" do
        (n, out) <- captureStdout (runFile "test/Fixtures/Coverage/th_facade_source.hs")
        n   `shouldBe` 0
        out `shouldBe` "14\n"
    --------------------------------------------------------------------
