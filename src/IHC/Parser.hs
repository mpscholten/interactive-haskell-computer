  ...
  where
    goFirst cur =
        ...
        in case tkKind tok of
            ...
            -- MagicHash primop names like @quotInt#@, @plusFloat#@ used
            -- as infix via backticks in instance method bodies, e.g.
            --   I# x `quotInt#` I# y
            -- Without this, source-loaded Integral Int.{div,mod} bodies
            -- (which use this exact form) fail to parse.
