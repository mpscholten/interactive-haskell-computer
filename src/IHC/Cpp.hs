...
defaultCppContext = Map.fromList
    ...
    -- MachDeps.h / ghcautoconf.h SIZEOF_* and ALIGNMENT_* for the
    -- 64-bit host.  GHC.Internal.Foreign.Storable expands
    --   instance Storable Int where sizeOf _ = SIZEOF_HSINT
    -- via #include "MachDeps.h".  When IHC_GHC_INCLUDE_DIRS is unset
    -- the include is skipped and SIZEOF_HSINT stays a bare name —
    -- env-fallback then hangs inside sizeOf, which is
    -- Network.Socket.setSockOpt (setDontFragment after c_socket).
    -- Pre-defining the macros keeps the source instance usable.
    , ("SIZEOF_VOID_P",      MObj "8")
    , ("ALIGNMENT_VOID_P",   MObj "8")
    , ("SIZEOF_HSINT",       MObj "8")
    , ("ALIGNMENT_HSINT",    MObj "8")
    , ("SIZEOF_HSWORD",      MObj "8")
    , ("ALIGNMENT_HSWORD",   MObj "8")
    , ("SIZEOF_HSPTR",       MObj "8")
    , ("ALIGNMENT_HSPTR",    MObj "8")
    , ("SIZEOF_HSFUNPTR",    MObj "8")
    , ("ALIGNMENT_HSFUNPTR", MObj "8")
    , ("SIZEOF_HSSTABLEPTR", MObj "8")
    , ("ALIGNMENT_HSSTABLEPTR", MObj "8")
    , ("SIZEOF_HSDOUBLE",    MObj "8")
    , ("ALIGNMENT_HSDOUBLE", MObj "8")
    , ("SIZEOF_HSFLOAT",     MObj "4")
    , ("ALIGNMENT_HSFLOAT",  MObj "4")
    , ("SIZEOF_HSCHAR",      MObj "4")
    , ("ALIGNMENT_HSCHAR",   MObj "4")
    , ("SIZEOF_INT8",        MObj "1")
    , ("ALIGNMENT_INT8",     MObj "1")
    , ("SIZEOF_INT16",       MObj "2")
    , ("ALIGNMENT_INT16",    MObj "2")
    , ("SIZEOF_INT32",       MObj "4")
    , ("ALIGNMENT_INT32",    MObj "4")
    , ("SIZEOF_INT64",       MObj "8")
    , ("ALIGNMENT_INT64",    MObj "8")
    , ("SIZEOF_WORD8",       MObj "1")
    , ("ALIGNMENT_WORD8",    MObj "1")
    , ("SIZEOF_WORD16",      MObj "2")
    , ("ALIGNMENT_WORD16",   MObj "2")
    , ("SIZEOF_WORD32",      MObj "4")
    , ("ALIGNMENT_WORD32",   MObj "4")
    , ("SIZEOF_WORD64",      MObj "8")
    , ("ALIGNMENT_WORD64",   MObj "8")
    , ("SIZEOF_INT8_T",      MObj "1")
    , ("ALIGNMENT_INT8_T",   MObj "1")
    , ("SIZEOF_UINT8_T",     MObj "1")
    , ("ALIGNMENT_UINT8_T",  MObj "1")
    , ("SIZEOF_INT16_T",     MObj "2")
    , ("ALIGNMENT_INT16_T",  MObj "2")
    , ("SIZEOF_UINT16_T",    MObj "2")
    , ("ALIGNMENT_UINT16_T", MObj "2")
    , ("SIZEOF_INT32_T",     MObj "4")
    , ("ALIGNMENT_INT32_T",  MObj "4")
    , ("SIZEOF_UINT32_T",    MObj "4")
    , ("ALIGNMENT_UINT32_T", MObj "4")
    , ("SIZEOF_INT64_T",     MObj "8")
    , ("ALIGNMENT_INT64_T",  MObj "8")
    , ("SIZEOF_UINT64_T",    MObj "8")
    , ("ALIGNMENT_UINT64_T", MObj "8")
    , ("SIZEOF_FLOAT",       MObj "4")
    , ("ALIGNMENT_FLOAT",    MObj "4")
    , ("SIZEOF_DOUBLE",      MObj "8")
    , ("ALIGNMENT_DOUBLE",   MObj "8")
    ]
